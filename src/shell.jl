...
mutable struct Shell <: FieldProblem
    debug :: Bool
end
...
function FEMBase.get_unknown_field_name(::Problem{Shell})
    return "displacement"
end

function FEMBase.assemble_elements!(problem::Problem{Shell},
                                    assembly::Assembly,
    ...
    for element in elements
        ...
        rP = element("geometry", (0.0, 0.0), time)
